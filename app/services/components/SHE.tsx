...
const SHE = () => {
  return (
    <div className="flex flex-col w-full">
      <div className="relative flex flex-col items-center bg-[#EDEEEE] overflow-hidden">
        ...
        <div className="relative flex flex-row">
          ...
          <Image src={ PPE } alt="ppe" className="rounded w-[400px] lg:w-[700px] h-auto" />
          <div className="absolute w-[60%] h-4 top-[450px] left-[130px] bg-[#F19221]"></div>
        </div>
        <p className="mx-10 lg:w-[700px] lg:mx-64 lg:my-4 text-[14px] lg:text-[16px]">We are fully committed to improving Health, safety and environmental performance
        ...
        <div className="absolute flex flex-row w-[230px] h-[270px] -right-[115px] top-36 items-center justify-center bg-[#F19221] clip-hexagon">
