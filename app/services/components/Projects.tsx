            ...
            return (
              <div key={ index } className="flex flex-col lg:flex-row my-4 lg:my-10 gap-x-12">
                ...
                <div className="flex flex-col items-center">
                  <div style={ { backgroundImage: `url(${project.images[currentIndex].src})` } } className="flex flex-col w-[350px] lg:w-[550px] h-[350px] lg:h-[400px] items-center duration-500 rounded-md bg-cover bg-center">
                  </div>
                  ...
                  <div className="flex flex-row gap-x-6 my-3">
                    <button className="bg-[#F19221] rounded-full" aria-label="previous image" type="button" onClick={ () => {
                    ...
                    <button className="bg-[#F19221] rounded-full" aria-label="next image" type="button" onClick={ () => {
