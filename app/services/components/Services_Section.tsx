    ...
    <div className="overflow-hidden">
      <div className="w-full h-[300px] lg:h-[400px] bg-[url('/assets/services_2.jpg')] bg-cover">
        <div className="flex flex-col gap-y-10 justify-center items-center bg-[#1419499A] w-full h-full">
          ...
          <p className="text-[16px] text-center mx-3 lg:mx-0 lg:w-[50%] text-white">We offer comprehensive and reliable mechanical and
      ...
      <div className="flex flex-col lg:flex-row lg:gap-x-14 my-6 lg:my-24 z-0">
        ...
        <div className="relative flex flex-row lg:ml-44">
